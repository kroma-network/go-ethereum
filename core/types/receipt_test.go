...
var (
	bedrockGenesisTestConfig = func() *params.ChainConfig {
		...
		conf.Kroma = &params.KromaConfig{EIP1559Elasticity: 50, EIP1559Denominator: 10}
		return &conf
	}()
...
func TestDeriveOptimismBedrockTxReceipts(t *testing.T) {
	...
	payload := common.Hex2Bytes("")
...
func TestDeriveOptimismEcotoneTxReceipts(t *testing.T) {
	// Ecotone style l1 attributes with baseFeeScalar=2, blobBaseFeeScalar=3, baseFee=1000*1e6, blobBaseFee=10*1e6, validatorRewardScalar=0
