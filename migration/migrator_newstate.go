...
func (m *StateMigrator) applyAccountChanges(
	tr *trie.StateTrie,
	bn uint64,
	root common.Hash,
	accountChanges map[common.Hash][]byte,
	storageChanges map[common.Hash]map[common.Hash][]byte,
) error {
...
func (m *StateMigrator) applyStorageChanges(
	mptStorageTrie *trie.StateTrie,
	storageRoot common.Hash,
	changes map[common.Hash][]byte,
