...
type BuildPayloadArgs struct {
	...
	NoTxPool     bool                 // Kroma addition: option to disable tx pool contents from being included
	Transactions []*types.Transaction // Kroma addition: txs forced into the block via engine API
	GasLimit     *uint64              // Kroma addition: override gas limit of the block to build
}
