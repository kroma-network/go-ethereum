...
// from the database.
func (t *ZkTrie) Commit(bool) (common.Hash, *NodeSet, error) {
...
func (t *ZkTrie) TryDeleteAccount(key []byte) error {
	// NOTE(chokobole): Both odrTrie and StateTrie seems to share logic
	// between TryDelete and TryDeleteAccount.
