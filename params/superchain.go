...
func LoadOPStackChainConfig(chainID uint64) (*ChainConfig, error) {
	...
	// We decided to keep the code related to superchains, which resulted in compilation errors in code closely related to the optimization setup.
	//
	// To facilitate upstreaming, we commented out the compilation errors instead of deleting them.
