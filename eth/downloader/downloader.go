...
func New(checkpoint uint64, stateDb ethdb.Database, mux *event.TypeMux, chain BlockChain, lightchain LightChain, dropPeer peerDropFn, success func(), zk bool) *Downloader {
	if lightchain == nil {
		lightchain = chain
	}
	dl := &Downloader{
